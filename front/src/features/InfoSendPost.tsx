...
const InfoSendPost = () => {
    return (
        <div className={'m-10 p-5 border border-chart-2 bg-chart-4/20 rounded-lg max-w-8xl overflow-hidden'}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 justify-items-center">
                <div className="flex flex-col items-center ">
                    <div className="mb-2 text-center text-shadow-md w-35 sm:w-48 lg:w-71 break-words px-1">Посылканы онлайн каттоодон откор</div>
