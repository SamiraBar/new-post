...
const selectableCountries: Array<'RU' | 'KZ' | 'BY'> = ['RU', 'KZ', 'BY'];
...
export const PhoneInput = ({
  ...
  const [selectedCountry, setSelectedCountry] = useState<'RU' | 'KZ' | 'BY' | 'KG'>(defaultCountry);
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);

  const handleCountryChange = (country: 'RU' | 'KZ' | 'BY') => {
  ...
  const showSelector = defaultCountry !== 'KG';
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <>
                ...
                <div className="absolute top-full left-0 mt-1 w-48 bg-white border-2 border-gray-300 rounded-lg shadow-lg z-50">
                  {selectableCountries.map((country) => (
                    <button
                      ...
                      className={`
                        ...
                        ${selectedCountry === country ? 'bg-orange-50' : ''}
                        first:rounded-t-lg last:rounded-b-lg
                      `}
                    >
                      <span className="text-2xl">{countryData[country].flag} </span>
                      <div className="flex flex-col items-start">
                        <span className="font-medium text-sm">{countryData[country].name}</span>
                        <span className="text-xs text-gray-500">{countryData[country].code}</span>
                      </div>
                    </button>
                  ))}
                </div>
        ...
        <div className="flex-1">
          <IMaskInput
            ...
            className={`
              ...
              bg-gray-50 focus:bg-white focus:ring-2 focus:ring-offset-1 outline-none
              ${error
