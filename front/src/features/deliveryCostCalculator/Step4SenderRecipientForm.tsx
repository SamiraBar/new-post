...
const Step4SenderRecipientForm: FC<Props> = ({
  ...
  const handlePhoneChange = (phone: string, type: 'sender' | 'receiver') => {
    ...
    } as ChangeEvent<HTMLInputElement>, type);
  ...
  const isAddressValid = !doorDelivery || (doorDelivery && (order.receiver.address || '').trim().length >= 5);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <FieldGroup className="gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    {isReceiverNameValid && isReceiverEmailValid && isReceiverPhoneValid &&
