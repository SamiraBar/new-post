          ...
          <form className="w-full lg:flex pt-5">
            ...
            <div className="shadow-lg border flex flex-col gap-4 p-5 rounded-lg w-full mt-5 lg:mt-0 lg:ml-5 lg:w-1/2">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="text-2xl md:text-3xl text-orange-500 font-bold">{deliveryCost} сом</span>
              </div>
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="text-2xl md:text-3xl text-blue-500 font-bold">{insuranceCost} сом</span>
              </div>
              ...
              <div className="flex items-center justify-between gap-3 border-t-2 border-orange-200 pt-3">
                ...
                <span className="text-2xl md:text-3xl text-green-500 font-bold">{totalCost} сом</span>
              </div>
