...
import { Clock, HandCoins, TriangleAlert, Weight, ArrowLeft, ArrowRight } from 'lucide-react';
...
const offices = [
  ...
  { id: 2, name: 'Офис Бишкек - Восток', address: 'мкр. Восток-5' },
  { id: 3, name: 'Офис Ош', address: 'ул. Ленина 50' },
  { id: 4, name: 'Офис Каракол', address: 'ул. Гебзе 45' },
        ...
        <div className="p-2 sm:p-5 bg-yellow-50 rounded-lg">
          <div className="flex justify-center mb-8">
            <div className="flex items-center gap-4">
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${currentStep >= 1 ? 'bg-orange-500 text-white' : 'bg-gray-300'}`}>
                1
              </div>
              <div className={`w-20 h-1 ${currentStep >= 2 ? 'bg-orange-500' : 'bg-gray-300'}`}></div>
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${currentStep >= 2 ? 'bg-orange-500 text-white' : 'bg-gray-300'}`}>
                2
              </div>
              <div className={`w-20 h-1 ${currentStep >= 3 ? 'bg-orange-500' : 'bg-gray-300'}`}></div>
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${currentStep >= 3 ? 'bg-orange-500 text-white' : 'bg-gray-300'}`}>
                3
              </div>
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${currentStep >= 4 ? 'bg-orange-500 text-white' : 'bg-gray-300'}`}>
                4
              </div>
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${currentStep >= 5 ? 'bg-orange-500 text-white' : 'bg-gray-300'}`}>
                5
              </div>
            </div>
          </div>
