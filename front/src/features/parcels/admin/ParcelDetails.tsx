...
import {
  ArrowLeft, Boxes, Copy, Mail, MapPin, Package, Phone, User, Weight,
  Building2, Clock, CreditCard, Banknote, Store
} from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto p-6 bg-white space-y-10 text-[15px] text-gray-900">
        ...
        {parcel.pvzData && (
            <Card className="border-orange-300 rounded-md overflow-hidden bg-orange-50/30">
              <div className="bg-orange-500 text-white px-4 py-2 flex items-center gap-2 -mt-6">
                <Building2 size={20} />
