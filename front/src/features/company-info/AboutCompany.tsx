...
const AboutCompany = () => {
    return (
        <section
            id="about"
            className="w-full px-4 pt-0 py-10 max-w-full sm:max-w-xl md:max-w-5xl mx-auto"
        >
            <Card className="flex flex-col p-6 md:p-8 shadow-md rounded-2xl transition-transform transform hover:scale-105">
