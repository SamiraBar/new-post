...
contactsRouter.post("/", auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
...
contactsRouter.get("/", auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
...
contactsRouter.get("/:id", auth, async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { id } = req.params;
